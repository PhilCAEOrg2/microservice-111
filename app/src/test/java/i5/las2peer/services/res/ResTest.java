...
assertThat(response, both(isA(JSONObject.class)).and(asJSONObject(hasField("users", both(isA(JSONArray.class)).and(asJSONObjectArray(hasItemInArray(both(isA(JSONObject.class)).and(asJSONObject(hasField("id", isA(Number.class)))))))))));
